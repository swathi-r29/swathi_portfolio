          ...
          <div className="contact-info-column">
            ...
            <div className="services-offer">
              ...
              <div className="services-grid-mini">
                <div className="service-tag-mini">💻 Web Applications</div>
                <div className="service-tag-mini">🌐 Website Development</div>
                <div className="service-tag-mini">📱 Responsive Design</div>
                <div className="service-tag-mini">⚙️ Backend Development</div>
              </div>
            </div>

            <div className="contact-socials">
              <a href="https://github.com/swathi-r29" className="social-icon-btn" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://www.linkedin.com/in/swathi-r-75216a28a/" className="social-icon-btn" target="_blank" rel="noopener noreferrer">
